...
class CycleGenerator(nn.Module):
    ...
    def __init__(self, conv_dim=64, init_zero_weights=False):
        ...
        self.conv1 = conv(3,32,kernel_size=4)
        self.conv2 = conv(32,conv_dim,kernel_size=4)
        ...
        self.deconv1 = deconv(conv_dim, 32, kernel_size=4)
        self.deconv2 = deconv(32, 3, kernel_size=4)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv1 = conv(3,32,kernel_size=4)
        self.conv2 = conv(32,conv_dim,kernel_size=4)
        self.conv3 = conv(conv_dim,128,kernel_size=4)
        self.conv4 = conv(128,1,kernel_size=4,padding = 0)
